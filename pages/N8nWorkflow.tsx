            ...
            <div className="grid md:grid-cols-2 gap-8">
                <div>
                    ...
                    <ul className="list-disc pl-5 space-y-2 text-slate-600">
                        ...
                        <li><strong>Important:</strong> Set "Response Mode" to "Last Node" (or use a Respond to Webhook node at the end).</li>
                        <li>The webhook will receive JSON body: <code>{`{ "image": "base64...", "color": "Red", "productName": "Chair" }`}</code>.</li>
                    </ul>
                </div>
